...
public class Menu extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        try{
            Class oc=Class.forName("com.sridhar.deepak.digitdetection."+ c);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.au:
                Intent i=new Intent("com.sridhar.deepak.digitdetection.ABOUT");
                startActivity(i);
                break;
            case R.id.p:
                Intent is=new Intent("com.sridhar.deepak.digitdetection.PREF");
                startActivity(is);
                break;
            case R.id.e:
                finish();
